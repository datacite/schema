...
public class SchemaDirectory {
    ...
    // public final static String INDEX_HTML = System.getProperty("index.html", "index.html.md");
    public final static String INDEX_HTML = System.getProperty("metadata.xsd");
